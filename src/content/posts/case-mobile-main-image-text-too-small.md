---
title: "案例：电脑端主图很好看，手机端却看不清卖点"
description: "这篇文章围绕电脑端主图很好看，手机端却看不清卖点展开，帮助亚马逊卖家用更清晰的步骤判断问题、拆解数据、降低试错成本，适合阿岩跨境笔记读者做日常运营复盘。"
pubDate: "2026-06-25"
category: "Listing 优化"
tags: ["Listing", "主图", "移动端"]
image: "/images/articles/case-mobile-main-image-text-too-small/cover.svg"
draft: false
topic: listing
stage: 实操
intent: 决策
...
某宠物用品主图在电脑端看起来信息丰富，有产品、有场景、有卖点符号。但手机端缩略图里，主体显小，关键卖点几乎看不清，买家只能看到一堆元素。广告 CTR 长期偏低。
...
错误路径是继续增加图中文字和装饰元素，以为信息越多越能说服买家。
...
正确路径是按移动端优先重做主图，让主体占比、轮廓、差异化元素先被看见，再把复杂解释放到副图和 A+。
...
这个案例可以和 [移动端优先优化](/articles/listing-mobile-first-optimization/)、[主图点击率诊断](/articles/listing-main-image-ctr-checklist/) 一起看。方法文解决的是判断框架，案例文解决的是具体场景。两者结合起来，才不容易把一个局部问题误判成整体机会。

## 结果

新图上线后，点击率有明显改善，后续再结合价格和五点观察转化。
...
如果你需要把这个案例落到表格里，可以配合 [Listing 自检清单](/resources/listing-checklist/) 做复盘。站内也可以继续看 [移动端优先优化](/articles/listing-mobile-first-optimization/)、[主图点击率诊断](/articles/listing-main-image-ctr-checklist/)，把方法和案例串起来。
